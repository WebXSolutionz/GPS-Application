...
if($_SERVER['REQUEST_METHOD'] === "POST")
{
    ...
    if(!empty($mac))
    {
       ...
       $query = "Delete from user_data where MAC = '$mac'";

        mysqli_query($con, $query);

        $queryGPS = "Delete from gps_data where MAC = '$mac'";
...
<head>
    ...
    <title>SB Admin 2 - Delete User</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row w-100 d-flex align-items-center">
                        <form class="w-100 px-4" name = "delUser" method = "post">
                            <div class="form-group row">
                              <label for="FirstName" class="col-sm-2 col-form-label">First Name</label>
                              <div class="col-sm-10">
                                <input type="text" class="form-control" id="FirstName" name = "first_name" placeholder="Name">
                              </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="MacAddresss" class="col-sm-2 col-form-label">Mac Address</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name = "mac" id="MacAddress" placeholder = "Mac Address" required>
                                </div>
                            </div>
